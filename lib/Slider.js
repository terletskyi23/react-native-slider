...
return _react2.default.createElement(_reactNative.Image,{source:thumbImage,__source:{fileName:_jsxFileName,lineNumber:639}});
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Slider,[{key:"componentWillMount",value:function componentWillMount(){this._panResponder=_reactNative.PanResponder.create({onStartShouldSetPanResponder:this._handleStartShouldSetPanResponder,onMoveShouldSetPanResponder:this._handleMoveShouldSetPanResponder,onPanResponderGrant:this._handlePanResponderGrant,onPanResponderMove:this._handlePanResponderMove,onPanResponderRelease:this._handlePanResponderEnd,onPanResponderTerminationRequest:this._handlePanResponderRequestEnd,onPanResponderTerminate:this._handlePanResponderEnd});}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){var newValue=nextProps.value;if(this.props.value!==newValue){if(this.props.animateTransitions){this._setCurrentValueAnimated(newValue);}else{this._setCurrentValue(newValue);}}}},{key:"render",value:function render(){var _props=this.props,minimumValue=_props.minimumValue,maximumValue=_props.maximumValue,minimumTrackTintColor=_props.minimumTrackTintColor,maximumTrackTintColor=_props.maximumTrackTintColor,thumbTintColor=_props.thumbTintColor,thumbImage=_props.thumbImage,styles=_props.styles,style=_props.style,trackStyle=_props.trackStyle,thumbStyle=_props.thumbStyle,debugTouchArea=_props.debugTouchArea,isCustomMinMaxStyle=_props.isCustomMinMaxStyle,isCustomDisableValue=_props.isCustomDisableValue,other=_objectWithoutProperties(_props,["minimumValue","maximumValue","minimumTrackTintColor","maximumTrackTintColor","thumbTintColor","thumbImage","styles","style","trackStyle","thumbStyle","debugTouchArea","isCustomMinMaxStyle","isCustomDisableValue"]);var _state=this.state,value=_state.value,containerSize=_state.containerSize,trackSize=_state.trackSize,thumbSize=_state.thumbSize,allMeasured=_state.allMeasured;var mainStyles=styles||defaultStyles;var thumbLeft=value.interpolate({inputRange:[minimumValue,maximumValue],outputRange:[0,containerSize.width-thumbSize.width]});var thumbRight=value.interpolate({inputRange:[minimumValue,maximumValue],outputRange:[containerSize.width-thumbSize.width,0]});var valueVisibleStyle={};if(!allMeasured){valueVisibleStyle.opacity=0;}var minimumTrackStyle=_extends({position:'absolute',width:_reactNative.Animated.add(thumbLeft,thumbSize.width/2),backgroundColor:minimumTrackTintColor},valueVisibleStyle);var maximumTrackStyle=_extends({position:'absolute',width:_reactNative.Animated.add(thumbRight,thumbSize.width/2),backgroundColor:maximumTrackTintColor},valueVisibleStyle);var touchOverflowStyle=this._getTouchOverflowStyle();var visibility=null;var rightCustom={height:isCustomMinMaxStyle.maxStyle.height||20,opacity:isCustomMinMaxStyle.maxStyle.opacity||1};var leftCustom={height:isCustomMinMaxStyle.minStyle.height||20,opacity:isCustomMinMaxStyle.minStyle.opacity||1,top:18};var isCustomMinMaxStyle={isVisible:isCustomMinMaxStyle.isVisible||false,minStyle:_extends({position:'absolute',width:_reactNative.Animated.add(thumbLeft,8-thumbSize.width/2),backgroundColor:minimumTrackTintColor,borderBottomLeftRadius:5},leftCustom),maxStyle:_extends({position:'absolute',width:_reactNative.Animated.add(thumbRight,8-thumbSize.width/2),backgroundColor:maximumTrackTintColor,borderBottomRightRadius:5},rightCustom)};var isCustomDisableValue={isVisible:isCustomDisableValue.isVisible||false,thumbCustomValue:{width:isCustomDisableValue.thumbCustomValue.width||10,height:isCustomDisableValue.thumbCustomValue.height||10}};if(isCustomMinMaxStyle.isVisible){visibility=_react2.default.createElement(_reactNative.View,{style:{backgroundColor:"",boxSizing:'border-box',borderWidth:8,borderStyle:'solid',borderColor:'transparent'},__source:{fileName:_jsxFileName,lineNumber:345}},_react2.default.createElement(_reactNative.View,{style:[defaultStyles.customBackground],__source:{fileName:_jsxFileName,lineNumber:346}}),_react2.default.createElement(_reactNative.View,{style:[defaultStyles.rightTrackDownView],__source:{fileName:_jsxFileName,lineNumber:347}},_react2.default.createElement(_reactNative.Animated.View,{renderToHardwareTextureAndroid:true,style:[mainStyles.trackCustom,trackStyle,isCustomMinMaxStyle.maxStyle],onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:348}})),_react2.default.createElement(_reactNative.Animated.View,{renderToHardwareTextureAndroid:true,style:[mainStyles.trackCustom,trackStyle,isCustomMinMaxStyle.minStyle],__source:{fileName:_jsxFileName,lineNumber:353}}));}else if(isCustomDisableValue.isVisible){visibility=_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:360}},_react2.default.createElement(_reactNative.View,{style:[{backgroundColor:maximumTrackTintColor},mainStyles.track,trackStyle],renderToHardwareTextureAndroid:true,onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:361}}),_react2.default.createElement(_reactNative.Animated.View,{renderToHardwareTextureAndroid:true,style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:365}}),_react2.default.createElement(_reactNative.View,{onLayout:this._measureThumb,renderToHardwareTextureAndroid:true,style:[{backgroundColor:"#000"},mainStyles.thumb,thumbStyle,isCustomDisableValue.thumbCustomValue],__source:{fileName:_jsxFileName,lineNumber:368}}));}else{visibility=_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:376}},_react2.default.createElement(_reactNative.View,{style:[defaultStyles.rightTrackView],__source:{fileName:_jsxFileName,lineNumber:377}},_react2.default.createElement(_reactNative.Animated.View,{renderToHardwareTextureAndroid:true,style:[mainStyles.track,trackStyle,maximumTrackStyle],onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:378}})),_react2.default.createElement(_reactNative.Animated.View,{renderToHardwareTextureAndroid:true,style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:383}}));}return _react2.default.createElement(_reactNative.View,_extends({},other,{style:[mainStyles.container,style],onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:391}}),visibility,_react2.default.createElement(_reactNative.Animated.View,{onLayout:this._measureThumb,renderToHardwareTextureAndroid:true,style:[{backgroundColor:thumbTintColor},mainStyles.thumb,thumbStyle,_extends({transform:[{translateX:thumbLeft},{translateY:0}]},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:394}},this._renderThumbImage()),_react2.default.createElement(_reactNative.View,_extends({renderToHardwareTextureAndroid:true,style:[defaultStyles.touchArea,touchOverflowStyle]},this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:411}}),debugTouchArea===true&&this._renderDebugThumbTouchRect(thumbLeft)));}},{key:"_getPropsForComponentUpdate",value:function _getPropsForComponentUpdate(props){var value=props.value,onValueChange=props.onValueChange,onSlidingStart=props.onSlidingStart,onSlidingComplete=props.onSlidingComplete,style=props.style,trackStyle=props.trackStyle,thumbStyle=props.thumbStyle,otherProps=_objectWithoutProperties(props,["value","onValueChange","onSlidingStart","onSlidingComplete","style","trackStyle","thumbStyle"]);return otherProps;}},{key:"_handleMoveShouldSetPanResponder",value:function _handleMoveShouldSetPanResponder(){return false;}},{key:"_handlePanResponderRequestEnd",value:function _handlePanResponderRequestEnd(e,gestureState){return false;}}]);return Slider;}(_react.PureComponent);Slider.propTypes={value:_propTypes2.default.number,disabled:_propTypes2.default.bool,minimumValue:_propTypes2.default.number,maximumValue:_propTypes2.default.number,step:_propTypes2.default.number,minimumTrackTintColor:_propTypes2.default.string,maximumTrackTintColor:_propTypes2.default.string,thumbTintColor:_propTypes2.default.string,thumbTouchSize:_propTypes2.default.shape({width:_propTypes2.default.number,height:_propTypes2.default.number}),onValueChange:_propTypes2.default.func,onSlidingStart:_propTypes2.default.func,onSlidingComplete:_propTypes2.default.func,style:_reactNative.ViewPropTypes.style,trackStyle:_reactNative.ViewPropTypes.style,thumbStyle:_reactNative.ViewPropTypes.style,thumbImage:_reactNative.Image.propTypes.source,debugTouchArea:_propTypes2.default.bool,animateTransitions:_propTypes2.default.bool,animationType:_propTypes2.default.oneOf(['spring','timing']),animationConfig:_propTypes2.default.object,isCustomMinMaxStyle:_propTypes2.default.shape({isVisible:_propTypes2.default.bool,minStyle:_propTypes2.default.shape({height:_propTypes2.default.number,opacity:_propTypes2.default.number}),maxStyle:_propTypes2.default.shape({height:_propTypes2.default.number,opacity:_propTypes2.default.number})}),isCustomDisableValue:_propTypes2.default.shape({isVisible:_propTypes2.default.bool,thumbCustomValue:_propTypes2.default.shape({width:_propTypes2.default.number,height:_propTypes2.default.number})})};Slider.defaultProps={value:0,minimumValue:0,maximumValue:1,step:0,minimumTrackTintColor:'#3f3f3f',maximumTrackTintColor:'#b3b3b3',thumbTintColor:'#343434',thumbTouchSize:{width:40,height:40},debugTouchArea:false,animationType:'timing',isCustomMinMaxStyle:{isVisible:false,minStyle:{height:20,opacity:1},maxStyle:{height:30,opacity:1}},isCustomDisableValue:{isVisible:false,thumbCustomValue:{width:10,height:10}}};exports.default=Slider;
